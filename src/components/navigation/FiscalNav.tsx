...
import { LayoutDashboard, Route, UserCheck } from 'lucide-react';

const NAV_ITEMS = [
  { href: '/dashboard', label: 'Visão Geral', icon: LayoutDashboard, exact: true },
  { href: '/dashboard/vias', label: 'Minhas Vias', icon: Route },
  { href: '/dashboard/profile', label: 'Meu Perfil', icon: UserCheck },
];
